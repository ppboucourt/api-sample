...
class EmployeeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Employee entity")
        ...
        .repeat(2) {
            ...
            .post("/api/employees")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "email":"SAMPLE_TEXT", "mobile":"SAMPLE_TEXT", "npiNumber":"SAMPLE_TEXT", "deaNumber":"SAMPLE_TEXT", "status":"SAMPLE_TEXT", "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))

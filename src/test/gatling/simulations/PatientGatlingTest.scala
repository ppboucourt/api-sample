...
class PatientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Patient entity")
        ...
        .repeat(2) {
            ...
            .post("/api/patients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "social":"SAMPLE_TEXT", "status":"SAMPLE_TEXT", "identification":"SAMPLE_TEXT", "sex":null, "dateBirth":"2020-01-01T00:00:00.000Z", "preferredName":"SAMPLE_TEXT", "firstName":"SAMPLE_TEXT", "middleName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))

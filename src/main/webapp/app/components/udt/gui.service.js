(function() {
    ...
    function GUIUtils () {
        ...
        var service = {
            ...
            icd10CodeToListNames: icd10CodeToListNames,
            getGender: getGender,
            ...
            colorHtmlStatus: colorHtmlStatus
        ...
        function icd10CodeToListNames(data) {
                var codes = '';
        ...
        function getMaritalStatus() {
            return ['Single', 'Divorced', 'Married'];
        }

        function getRace() {
            return ['White', 'Black', 'Mestizo'];
        }

        function getEthnicity() {
            return ['Anglo', 'Afro-American', 'Hispanic-Latin', 'Asian']
        }
        ...
        function resetUserPicture(data){
            data.picture = getDefaultUserPicture();
            data.pictureContentType = getDefaultUserPictureContentType();
        }
        ...
        function colorHtmlStatus(value) {
            if(value){
                switch(value) {
                    case 'Pending':
                        return getStatusTemplate(value, 'danger');
                    case 'InProcess':
                        return getStatusTemplate(value, 'warning');
                    case 'PendingReview':
                        return getStatusTemplate(value, 'warning');
                    case 'Finalized':
                        return getStatusTemplate(value, 'success');
                    case 'Completed':
                        return getStatusTemplate(value, 'success');
                    case 'Revoked':
                        return getStatusTemplate(value, 'danger');
                    default :
                        return getStatusTemplate(value, 'info');
                }
            }
        }

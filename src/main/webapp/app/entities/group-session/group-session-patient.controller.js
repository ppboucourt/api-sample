(function() {
    ...
    angular
        .module('bluebookApp')
        .controller('GroupSessionPatientController', GroupSessionPatientController);

    GroupSessionPatientController.$inject = ['$scope', '$state', 'GroupSession', 'GroupSessionSearch', '$q', 'DTColumnBuilder' ,
        'DTOptionsBuilder', 'GUIUtils', '$filter', 'moment', 'CoreService', 'chart'];

    function GroupSessionPatientController ($scope, $state, GroupSession, GroupSessionSearch, $q, DTColumnBuilder,
                                     DTOptionsBuilder, GUIUtils, $filter, moment, CoreService, chart ) {
        var vm = this;

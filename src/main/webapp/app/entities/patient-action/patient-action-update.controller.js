(function () {
    ...
    angular
        .module('bluebookApp')
        .controller('PatientActionUpdateController', PatientActionUpdateController);

    PatientActionUpdateController.$inject = ['$state', 'patientAction', 'Via', 'Employee', 'PatientAction'];

    function PatientActionUpdateController($state, patientAction,  Via, Employee, PatientAction) {
        var vm = this;

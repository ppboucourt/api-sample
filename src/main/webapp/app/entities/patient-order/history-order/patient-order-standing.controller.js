(function () {
    ...
    angular
        .module('bluebookApp')
        .controller('StandingHistoryOrderController', StandingHistoryOrderController);

    StandingHistoryOrderController.$inject = ['$compile', '$scope', '$state', 'PatientOrder', 'entity',
        '$q', 'DTColumnBuilder', 'DTOptionsBuilder', 'GUIUtils', '$filter', 'moment', '$parse', 'CoreService'];

    function StandingHistoryOrderController($compile, $scope, $state, PatientOrder, entity,
                                     $q, DTColumnBuilder, DTOptionsBuilder, GUIUtils, $filter, moment, $parse, CoreService) {
        var vm = this;
        ...
        vm.dtOptions = DTOptionsBuilder.fromFnPromise(function () {
            ...
            if (!vm.searchQuery || vm.searchQuery == '') {
                PatientOrder.standing_old({id : vm.patient.id}, function (result) {
                    vm.orders = result;

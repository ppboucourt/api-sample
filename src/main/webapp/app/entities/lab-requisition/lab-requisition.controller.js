(function() {
    ...
    LabRequisitionController.$inject = [ '$state', 'LabRequisition', 'LabRequisitionSearch', '$q', 'DTColumnBuilder' , 'DTOptionsBuilder', 'GUIUtils', '$filter', '$sessionStorage'];

    function LabRequisitionController ( $state, LabRequisition, LabRequisitionSearch, $q, DTColumnBuilder, DTOptionsBuilder, GUIUtils, $filter, $sessionStorage ) {
        var vm = this;

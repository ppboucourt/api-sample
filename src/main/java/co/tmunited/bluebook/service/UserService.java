...
import co.tmunited.bluebook.repository.AuthorityRepository;
...
import co.tmunited.bluebook.repository.search.UserSearchRepository;
import co.tmunited.bluebook.security.AuthoritiesConstants;
import co.tmunited.bluebook.security.SecurityUtils;
import co.tmunited.bluebook.service.util.RandomUtil;
import co.tmunited.bluebook.web.rest.vm.ManagedUserVM;
...
public class UserService {
    ...
    public Employee getEmployeeWithAuthorities() {
        ...
        Optional<Employee> employee = employeeRepository.findOneByUserId(user.getId());
